...
export default function CaseOperationsPage() {
  ...
  return <section className="space-y-4">
    ...
    {!loading && tab === "rules" ? <div className="grid gap-4 xl:grid-cols-[22rem_1fr]">
      {can("CaseOperations.ManageRules") && options ? <Card><h2 className="font-semibold">New Card Point Rule</h2><div className="mt-3 grid gap-3">
        ...
        <Field label="Effective from"><TextInput type="date" value={effectiveFrom} onChange={(event) => setEffectiveFrom(event.target.value)} /></Field>
    ...
    {!loading && tab === "routing" ? <div className="grid gap-4 xl:grid-cols-[22rem_1fr]">
      {can("CaseOperations.ManageRouting") && options ? <Card><h2 className="font-semibold">Office and Product Lane</h2><div className="mt-3 grid gap-3">
    ...
    {!loading && tab === "clawbacks" ? <div className="grid gap-4 xl:grid-cols-[22rem_1fr]">
      {can("CaseOperations.SubmitClawback") && user?.userType?.code === "COD" ? <Card><h2 className="font-semibold">Submit Clawback</h2><p className="mt-1 text-sm text-text-secondary">Credit Card points require a full reversal. Personal Finance commission supports a partial or full reversal.</p><div className="mt-3 grid gap-3">
