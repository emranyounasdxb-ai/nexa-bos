  ...
  return (
    <section className="min-w-0 max-w-5xl">
      <form
        ...
        className="overflow-hidden rounded-lg border border-brand-border bg-surface shadow-[var(--amafh-shadow-surface)]"
      >
        ...
        {error ? <div className="px-4 pb-3 sm:px-5"><ErrorText>{error}</ErrorText></div> : null}
        <div className="flex flex-wrap items-center justify-end gap-2 border-t border-brand-border bg-surface-subtle px-4 py-3 sm:px-5">
          <Button type="button" variant="secondary" disabled={submitting} onClick={() => router.push("/users")}>Cancel</Button>
