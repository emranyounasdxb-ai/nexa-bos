...
type Staff = { id: string; name: string; hasPhoto: boolean; photoUpdatedAt: string; applications: number; cc: number; pf: number; submitted: number; approved: number; funded: number; conversion: number | null; pendingReview: number; target: { assigned: string | null; achieved: string | null; remaining: string | null; achievementPct: number | null; measurement: string | null } };
