// Selected official Tabler Icons outline SVGs, pinned to upstream commit
...
export function IconBriefcase2(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconHierarchy3(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconDevices2(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconBuildingBank(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M3 21l18 0" />
      <path d="M3 10l18 0" />
...
export function IconBellCog(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconFileTypePdf(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M14 3v4a1 1 0 0 0 1 1h4" />
...
export function IconArrowsDiff(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M11 16h10" />
      <path d="M11 16l4 4" />
