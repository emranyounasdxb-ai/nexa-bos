...
export const PageHeaderSlots = createContext<{ description: HTMLElement | null; actions: HTMLElement | null } | null>(null);

export function PageHeader({ description, actions }: { title: string; description?: string; actions?: ReactNode }) {
