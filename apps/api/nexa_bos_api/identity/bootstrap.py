    ...
    system_defaults = {
        code: tuple(
            dict.fromkeys(
                ...
                + SYSTEM_APPROVAL_PERMISSION_DEFAULTS.get(code, ())
                + SYSTEM_CASE_OPERATIONS_PERMISSION_DEFAULTS.get(code, ())
            )
        )
        ...
        | SYSTEM_APPROVAL_PERMISSION_DEFAULTS.keys()
        | SYSTEM_CASE_OPERATIONS_PERMISSION_DEFAULTS.keys()
    }
